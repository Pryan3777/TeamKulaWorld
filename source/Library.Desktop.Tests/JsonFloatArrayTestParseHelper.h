...
namespace LibraryDesktopTests {
    class JsonFloatArrayTestParseHelper final : public JsonTestParseHelper {
        RTTI_DECLARATIONS(JsonFloatArrayTestParseHelper, JsonTestParseHelper);
    ...
    public:
        ...
        inline std::unique_ptr<IJsonParseHelper> Create() const override { return std::make_unique<JsonFloatArrayTestParseHelper>(); }
