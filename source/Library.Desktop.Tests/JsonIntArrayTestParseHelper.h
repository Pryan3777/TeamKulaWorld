...
namespace LibraryDesktopTests {
    class JsonIntArrayTestParseHelper final : public JsonTestParseHelper {
        RTTI_DECLARATIONS(JsonIntArrayTestParseHelper, JsonTestParseHelper);
    ...
    public:
        ...
        inline std::unique_ptr<IJsonParseHelper> Create() const override { return std::make_unique<JsonIntArrayTestParseHelper>(); }
