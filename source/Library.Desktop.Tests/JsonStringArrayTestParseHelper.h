...
namespace LibraryDesktopTests {
    class JsonStringArrayTestParseHelper final : public JsonTestParseHelper {
        RTTI_DECLARATIONS(JsonStringArrayTestParseHelper, JsonTestParseHelper);
    ...
    public:
        ...
        inline std::unique_ptr<IJsonParseHelper> Create() const override { return std::make_unique<JsonStringArrayTestParseHelper>(); }
