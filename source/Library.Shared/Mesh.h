...
namespace FieaGameEngine
{
    ...
    {
    public:
		Mesh(FieaGameEngine::Model& model, InputStreamHelper& streamHelper);
		Mesh(FieaGameEngine::Model& model, MeshData&& meshData);
    ...
    private:
        ...
        gsl::not_null<FieaGameEngine::Model*> mModel;
		MeshData mData;
    };
}