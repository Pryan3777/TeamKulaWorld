...
namespace FieaGameEngine
{
	...
	bool MouseComponent::GetButtonState(const Mouse::State& state, MouseButtons button) const
	{
		switch (button)
		{
			case FieaGameEngine::MouseButtons::Left:
				return state.leftButton;

			case FieaGameEngine::MouseButtons::Right:
				return state.rightButton;

			case FieaGameEngine::MouseButtons::Middle:
				return state.middleButton;				

			case FieaGameEngine::MouseButtons::X1:
				return state.xButton1;

			case FieaGameEngine::MouseButtons::X2:
